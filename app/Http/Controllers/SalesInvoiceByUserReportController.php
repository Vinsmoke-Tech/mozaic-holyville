    ...
    public function printSalesInvoicebyUserReport()
    {
        ...
        <table cellspacing=\"0\" cellpadding=\"1\" border=\"1\" width=\"100%\">
            <tr>
                ...
                <td width=\"10%\"><div style=\"text-align: center;\">PPN / Barang</div></td>
            ...
            foreach($data as $key=>$val){
                ...
                if(is_numeric($key)){
                    ...
                    $spreadsheet->getActiveSheet()->getStyle('M'.$j)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_LEFT);
                        ...
                        $sheet->setCellValue('M'.$j, number_format($val['subtotal_amount']-$val['discount_amount']+$val['ppn_amount'],2,'.',','));
                }
                $j++;
