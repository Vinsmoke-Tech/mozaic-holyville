...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan 10 Hari</li>
    </ol>
  </nav>
                ...
                <thead>
                    <tr>
                        <td colspan='3' style='text-align:center;'>
                            <div style='font-weight:bold'>Laporan 10 Hari
                            </div>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    @foreach ($data as $row)
                                        @if($row['account_id'] == 28)
                                            <tr>
                                               ...
                                               <td>{{ number_format($row['journal_voucher_amount'], 2) }}</td>
                                            </tr>
