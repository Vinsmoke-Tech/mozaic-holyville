                ...
                <tbody>
                   ...
                   @foreach ($data as $row )
                       <tr>
                        ...
                        <td style="text-align: right">{{ $ISARC->getStock($row['item_id'],$row['item_category_id'],$row['item_unit_id'],$row['warehouse_id']) }}</td>
                        <td>{{ number_format($ISARC->getItemUnitPrice($row['item_id']), 2) }}</td>
                        <td>{{ number_format($ISARC->getItemUnitCost($row['item_id']), 2) }}</td>
