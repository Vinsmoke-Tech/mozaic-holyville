...
<div class="card border border-dark">
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('item') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i
                    class="fa fa-angle-left"></i> Kembali</button>
        </div>
    </div>
                    ...
                    <div class="row form-group mt-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('item_category_id', $category, $items->item_category_id, ['class' =>
                                'selection-search-clear select-form']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control input-bb" name="item_code" id="item_code" type="text"
                                    autocomplete="off" value="{{ $items['item_code'] }}" />
                                <input class="form-control input-bb" name="item_id" id="item_id" type="text"
                                    autocomplete="off" value="{{ $items['item_id'] }}" hidden />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control input-bb" name="item_name" id="item_name" type="text"
                                    autocomplete="off" value="{{ $items['item_name'] }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <a class="text-dark">Barcode Barang<a class='red'> *</a></a>
                                <input class="form-control input-bb" name="item_barcode" id="item_barcode" type="text"
                                    autocomplete="off" value="{{ $items['item_barcode'] }}" />
                            </div>
                        </div>
                        <div class="col-md-8 mt-3">
                            <div class="form-group">
                                <a class="text-dark">Keterangan<a class='red'> *</a></a>
                                <textarea class="form-control input-bb" name="item_remark" id="item_remark" type="text"
                                    autocomplete="off">{{ $items['item_remark'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row form-group mt-2">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('item_unit_id', $itemunits, $items->item_unit_id, ['class' =>
                                'selection-search-clear select-form']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control input-bb" name="item_quantity" id="item_quantity"
                                    type="number" autocomplete="off" value="{{ $items['item_default_quantity'] }}" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <a class="text-dark">Harga Jual 1<a class='red'> *</a></a>
                                <input class="form-control input-bb" name="item_price" id="item_price" type="number"
                                    autocomplete="off" value="{{ $items['item_unit_price'] }}" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <a class="text-dark">Harga Beli 1<a class='red'> *</a></a>
                                <input class="form-control input-bb" name="item_cost" id="item_cost" type="number"
                                    autocomplete="off" value="{{ $items['item_unit_cost'] }}" />
                            </div>
                        </div>
                    </div>
                </div>
