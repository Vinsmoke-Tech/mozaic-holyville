                            ...
                            @endphp
                                @foreach ($salesinvoiceitem as $salesinvoiceitem )
                                    <tr>
                                        ...
                                        <td style="text-align: right">{{ number_format($salesinvoiceitem['discount_amount']) }}</td>
                                        <td style="text-align: right">{{ number_format($salesinvoiceitem['ppn_amount']) }}</td>
                                        <td style="text-align: right">{{ number_format(($salesinvoiceitem['subtotal_amount']-$salesinvoiceitem['discount_amount']+$salesinvoiceitem['ppn_amount']),2,'.',',') }}</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <td colspan="9">Total Barang</td>
                                    <td style="text-align: right ">{{ $salesinvoice['subtotal_item'] }}</td>
                                </tr>
                                <tr>
                                    <td colspan="9">Subtotal</td>
                                    <td style="text-align: right ">{{ number_format($salesinvoice['subtotal_amount']+$salesinvoice['ppn_amount_total'],2,'.',',') }}</td>
                                </tr>
                                <tr>
