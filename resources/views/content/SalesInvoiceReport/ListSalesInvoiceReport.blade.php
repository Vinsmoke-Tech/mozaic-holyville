                ...
                <div class = "row">
                    ...
                    <div class = "col-md-6">
                        <div class="form-group form-md-line-input">
                            ...
                            {!! Form::select(' ',  $category_id, $item_category_id,  ['class' => 'form-control selection-search-clear select-form', 'id' => 'item_category_id', 'name' => 'item_category_id']) !!}
                        </div>
                    </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $SIRC->getCategoryName($row['item_category_id']) }}</td>
                    ...
                    <td style="text-align: right">{{ number_format(($row['subtotal_amount']-$row['discount_amount']+$row['ppn_amount']),2,'.',',') }}</td>
                  </tr> 
                  @endforeach
                </tbody>
            </table>
