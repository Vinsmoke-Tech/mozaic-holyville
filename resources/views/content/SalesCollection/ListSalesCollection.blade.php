            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$collection['collection_allocated']}}</td>
                        <td class="">
                            <a type="button" class="btn btn-outline-primary btn-sm" href="{{ url('/sales-collection/detail/'.$collection['collection_id']) }}">Detail</a>
                            <a hidden type="button" class="btn btn-outline-dark btn-sm" href="{{ url('/sales-collection/printing/'.$collection['collection_id']) }}"  target='_blank'>Print</a>
                            <a hidden type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/sales-collection/delete/'.$collection['collection_id']) }}">Batal</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
