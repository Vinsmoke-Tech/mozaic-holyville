...
<h3 class="page-title">
    <b>Daftar Jurnal Khusus </b> <small>Kelola Daftar Jurnal Khusus  </small>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{ route('filter-journal-special') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            ...
            <div class="card-footer text-muted">
                <div class="form-actions float-right">
                    <a href="{{ route('reset-filter-journal-special') }}" type="reset" name="Reset" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="form-actions float-right">
        <button onclick="location.href='{{ url('/journal-special/add') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Jurnal Khusus </button>
    </div>
  </div>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-success" href="{{ route('print-journal-special-all') }}"> Cetak Jurnal Khusus </a>
            <a class="btn btn-info" href="{{ route('print-journal-special-debit') }}"> Cetak Jurnal Debit </a>
            <a class="btn btn-warning" href="{{ route('print-journal-special-credit') }}"> Cetak Jurnal Credit </a>
