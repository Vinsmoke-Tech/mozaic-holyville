...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('journal-voucher') }}">Daftar Jurnal Special</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Jurnal Special</li>
    </ol>
  </nav>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-6 mt-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('journal_categories_id',  $account, 0, ['class' => 'selection-search-clear select-form', 'id' => 'journal_categories_id']) !!}
                    </div>
                </div>
                <div class="col-md-6 mt-4">
                    <div class="form-group">
                        <a class="text-dark">Formula<a class='red'> *</a></a>
                        <select name="journal_categories_item_formula_description" id="journal_categories_item_formula_description" class="form-control selection-search-clear select-form"></select>
                    </div>
                </div>
