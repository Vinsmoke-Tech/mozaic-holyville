                ...
                <div role="tabpanel" class="tab-pane fade" id="penjualan">
                    <table class="table table-borderless mt-3">
                        ...
                        <tr>
                            <th style="text-align: left !important; width: 40% !important">Kas</th>
                            <td style="text-align: left !important; width: 30% !important">
                                {!! Form::select(0, $accountlist, $sales_cash_account['account_id'],['class' => 'selection-search-clear select-form','name'=>'account_receivable_account_id','id'=>'account_receivable_account_id']) !!}
                            </td>
                            <td style="text-align: left !important; width: 30% !important">
                                {!! Form::select(0, $status, $sales_cash_account['account_setting_status'],['class' => 'selection-search-clear select-form','name'=>'account_receivable_account_status','id'=>'account_receivable_account_status']) !!}
                            </td>
                        </tr>
                        <tr>
                            <th style="text-align: left !important; width: 40% !important">Penjualan</th>
                            <td style="text-align: left !important; width: 30% !important">
                                {!! Form::select(0, $accountlist, $sales_account['account_id'],['class' => 'selection-search-clear select-form','name'=>'sales_account_id','id'=>'sales_account_id']) !!}
                            </td>
                            <td style="text-align: left !important; width: 30% !important">
                                {!! Form::select(0, $status, $sales_account['account_setting_status'],['class' => 'selection-search-clear select-form','name'=>'sales_account_status','id'=>'sales_account_status']) !!}
                            </td>
                        </tr>
                    </table>
                </div>
