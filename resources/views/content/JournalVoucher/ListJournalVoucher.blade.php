...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-success" href="{{ route('print-journal-voucher-all') }}"> Cetak Jurnal Umum </a>
            <a class="btn btn-info" href="{{ route('print-journal-voucher-debit') }}"> Cetak Jurnal Debit </a>
            <a class="btn btn-warning" href="{{ route('print-journal-voucher-credit') }}"> Cetak Jurnal Credit </a>
