            ...
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input style="width: 100%" class="form-control input-bb" name="purchase_invoice_date" id="purchase_invoice_date" type="date" autocomplete="off" onchange="function_elements_add(this.name, this.value)" value="{{ $datases['purchase_invoice_date'] ?? ''}}"/>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">Metode Pembelian<a class='red'> *</a></a>
                        {!! Form::select('purchase_method', $purchase_method_list, $datases['purchase_method'] ?? '', ['class' => 'form-control selection-search-clear select-form', 'id' => 'purchase_method','name' => 'purchase_method','onchange'=>'function_elements_add(this.name, this.value)']) !!}
                    </div>
                </div>
                <div class="col-md-6">
