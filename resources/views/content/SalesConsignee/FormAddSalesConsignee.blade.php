...
$('#item_id').change(function(){
    ...
    function processAddArraySalesInvoice(){
        ...
        $.ajax({
            type: "POST",
            url : "{{route('add-array-sales-consignee')}}",
            data: {
    ...
    function reset_add(){
		$.ajax({
				type: "GET",
				url : "{{route('add-reset-sales-consignee')}}",
				success: function(msg){
                    location.reload();
			}
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('sales-consignee') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>
...
<form method="post" action="{{ route('process-add-sales-consignee') }}" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
