...
<script>
    function reset_add(){
		$.ajax({
				type: "GET",
				url : "{{route('filter-reset-sales-consignee')}}",
...
@endif 
<div id="accordion">
    <form  method="post" action="{{ route('filter-sales-consignee') }}" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="form-actions float-right">
        <button onclick="location.href='{{ url('/sales-consignee/add') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Penjualan</button>
    </div>
  </div>
